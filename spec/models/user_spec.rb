...
RSpec.describe User, type: :model do
  ...
  describe 'ユーザー新規登録' do 
    ...
    it 'password:空欄' do
      @user.password = ''
      @user.valid?
      expect(@user.errors.full_messages).to include "Password can't be blank", "Password confirmation doesn't match Password", "Password is too short (minimum is 6 characters)", "Password is invalid"
    end
